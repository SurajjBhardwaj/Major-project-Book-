        ...
        <div className={styles.detail}>
                ...
                <div className={styles.title}>
                               ...
                               <div className={styles.div3}>
                                    Get ready to uncover the dark scerets and betrayals in the
                ...
                <div className={styles.item4}>
                                   ...
                                   <div className={styles.sec1}> 
                                            ...
                                            <div className={styles.part2}>
                                                The Story takes place during Harry's sixth year at
                                            ...
                                            <div className={styles.part4}>
                                                <Avatar alt="Seller_image" src="/profile/surajj.jpg" sx={{ width:"4.6rem", height:"4.6rem" }} /> 
                                            </div>
                                   ...
                                   <div className={styles.sec2}> 
                                            ...
                                            <Rating  className={styles.rev}name="half-rating-read" defaultValue={3.5} precision={0.5} readOnly />                                            
                                            ...
                                            <div className={styles.part5}>
                                                  <div className={styles.div1}>
                                                  <Avatar alt="Seller_image" src="/profile/ujala.png" sx={{ width:"4rem", height:"4rem" }} /> 
                                                  </div>
                                                  <div className={styles.div2}>
                                                  Ujala Kumari
                                                  </div>
                                                  <div className={styles.div3}>
                                                  Quality of this book Good like first
                                            ...
                                            <div className={styles.part6}>
                                            <div className={styles.div1}>
                                                  <Avatar alt="Seller_image" src="/profile/Aakash.png" sx={{ width:"4rem", height:"4rem" }} /> 
                                                  </div>
                                                  <div className={styles.div2}>
                                                  Aakash Verma
                                                  </div>
                                                  <div className={styles.div3}>
                                                  Amazing , Delivery is so fast and with I got my favourite 
